...
const Errors = require("../api/errors/list2023-main-error.js");
...
const logger = LoggerFactory.get("List2023MainAbl");

class List2023MainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "ShoppingList2023",
        typeCode: "shopping-list2023-maing01",
        location: location,
...
module.exports = new List2023MainAbl();
